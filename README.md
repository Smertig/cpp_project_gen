...
```bash
usage: generate_project.py [-h] [--project-model {cmake,compdb}] [--compiler COMPILER] [--sources SOURCES] [--headers HEADERS] [--subdirs SUBDIRS] [--header-lines HEADER_LINES] [--unique-header-lines] [--output OUTPUT] [--name NAME]
...
options:
  ...
  --unique-header-lines
                        generate unique lines in each header
